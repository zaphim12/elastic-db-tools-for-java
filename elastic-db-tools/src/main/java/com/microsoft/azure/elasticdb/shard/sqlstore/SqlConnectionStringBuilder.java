...
/**
 * Provides a simple way to create and manage the contents of connection strings used by the Connection class.
 */
public final class SqlConnectionStringBuilder {
    ...
    /**
     * Number of times to retry for a connection to the server before terminating the attempt and generating an error.
     */
    ...
    /**
     * Indicates whether User ID and Password are specified in the connection (when false) or whether the current Windows account credentials are used
    ...
    /**
     * Indicates if security-sensitive information, such as the password, is not returned as part of the connection if the connection is open or has
     * ever been in an open state.
     */
    ...
    /**
     * Initializes a new instance of the SqlConnectionStringBuilder class. The provided connection string provides the data for the instance's
     ...
     *
     * @param keyword
     *            The key to remove in the SqlConnectionStringBuilder.
     ...
     */
    public boolean setItem(String key,
            String value) {
     ...
     *
     * @param applicationNameSuffix
     *            MSQ Library Specific suffix
    ...
    public SqlConnectionStringBuilder withApplicationNameSuffix(String applicationNameSuffix) {
        this.applicationName = ApplicationNameHelper.addApplicationNameSuffix(this.applicationName, applicationNameSuffix);
        return this;
    }
}