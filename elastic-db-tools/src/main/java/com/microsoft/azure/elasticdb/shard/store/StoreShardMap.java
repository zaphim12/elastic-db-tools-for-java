...
public class StoreShardMap {
    ...
    /**
     * This variable is used to identify 'null' vs 'non-null' value of shardMap in xml. There is no business logic on top of this variable.
     */
