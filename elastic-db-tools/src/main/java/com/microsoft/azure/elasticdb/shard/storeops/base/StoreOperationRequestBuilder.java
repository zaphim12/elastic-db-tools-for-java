...
public final class StoreOperationRequestBuilder {
     ...
     *            Minimum start from which to start undo operation.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> findAndUpdateOperationLogEntryByIdGlobal(UUID operationId,
            StoreOperationState undoStartState) {
        QName rootElementName = new QName("FindAndUpdateOperationLogEntryByIdGlobal");
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withOperationId(operationId).withUndoStartState(undoStartState)
                .build();
    ...
    public static JAXBElement<StoreOperationInput> getAllShardMapsGlobal() {
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> findShardMapByNameGlobal(String shardMapName) {
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withShardMap(new StoreShardMap(null, shardMapName, null, null))
                .build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> addShardMapGlobal(StoreShardMap shardMap) {
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap)
                .build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *
     * @param shardMap
     *            ShardId map for which to get all shards.
     * @return Xml formatted request.
     */
     ...
     *
     * @param shardMap
     *            ShardId map for which to get shard.
     * @param location
     *            Location for which to find shard.
     * @return Xml formatted request.
     */
    ...
    public static JAXBElement<StoreOperationInput> addShardGlobal(UUID operationId,
        ...
        steps.add(new StoreOperationInput.Builder().withStepId(1).withStoreOperationStepKind(StoreOperationStepKind.Add)
                .withShard(shard == null ? StoreShard.NULL : shard).build());

        QName rootElementName = new QName("BulkOperationShardsGlobal");
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withOperationId(operationId).withOperationCode(operationCode)
                .withUndo(undo).withStepsCount(1).withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withSteps(steps).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *            Operation code.
     * @param undo
     *            Whether this is an undo request.
     * @param shardMap
     *            ShardId map for which operation is being requested.
     * @param shard
     *            ShardId to remove.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> removeShardGlobal(UUID operationId,
            ...
            StoreShard shard) {
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withStoreOperationStepKind(StoreOperationStepKind.Remove)
                .withShard(shard == null ? StoreShard.NULL : shard).build());
    ...
    public static JAXBElement<StoreOperationInput> updateShardGlobal(UUID operationId,
        ...
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withStoreOperationStepKind(StoreOperationStepKind.Update)
                .withShard(shardOld == null ? StoreShard.NULL : shardOld).withUpdate(innerInput).build());
    ...
    /**
     * Request to get all shard mappings from GSM for a particular shard map and optional shard and range.
     *
     * @param shardMap
     *            ShardId map whose mappings are being requested.
     * @param shard
     *            Optional shard for which mappings are being requested.
     * @param range
     *            Optional range for which mappings are being requested.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> getAllShardMappingsGlobal(StoreShardMap shardMap,
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap)
                .withShard(shard == null ? StoreShard.NULL : shard).withShardRange(range == null ? ShardRange.NULL : range).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> addShardMappingGlobal(UUID operationId,
        ...
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withValidation(true).withStoreOperationStepKind(StoreOperationStepKind.Add)
                .withMapping(mapping).build());

        QName rootElementName = new QName("BulkOperationShardMappingsGlobal");
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withOperationId(operationId).withOperationCode(operationCode)
                .withUndo(undo).withStepsCount(1).withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withRemoves(innerInput)
                .withAdds(innerInput).withSteps(steps).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> removeShardMappingGlobal(UUID operationId,
        ...
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withValidation(false).withStoreOperationStepKind(StoreOperationStepKind.Remove)
                .withMapping(mapping).withLock(new Lock(lockOwnerId == null ? new UUID(0L, 0L) : lockOwnerId, 0)).build());

        QName rootElementName = new QName("BulkOperationShardMappingsGlobal");
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withOperationId(operationId)
                .withStoreOperationCode(operationCode).withUndo(undo).withStepsCount(1).withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap)
                .withRemoves(innerInput).withAdds(innerInput).withSteps(steps).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *            Pattern to use for kill connection.
     * @param shardMap
     *            ShardId map for which operation is being requested.
     * @param mappingSource
     *            ShardId to update.
    ...
    public static JAXBElement<StoreOperationInput> updateShardMappingGlobal(UUID operationId,
            ...
            UUID lockOwnerId) {
        StoreOperationInput innerInputMapping = new StoreOperationInput.Builder().withMapping(mappingTarget).build();

        StoreOperationInput innerInputRemoves = new StoreOperationInput.Builder().withShard(mappingSource.getStoreShard()).build();

        StoreOperationInput innerInputAdds = new StoreOperationInput.Builder().withShard(mappingTarget.getStoreShard()).build();

        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withValidation(false).withStoreOperationStepKind(StoreOperationStepKind.Update)
                .withMapping(mappingSource).withLock(new Lock(lockOwnerId == null ? new UUID(0L, 0L) : lockOwnerId, 0)).withUpdate(innerInputMapping)
                .build());

        QName rootElementName = new QName("BulkOperationShardMappingsGlobal");
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withOperationId(operationId)
                .withStoreOperationCode(operationCode).withUndo(undo).withStepsCount(1).withPatternForKill(patternForKill)
                .withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withRemoves(innerInputRemoves).withAdds(innerInputAdds)
                .withSteps(steps).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> replaceShardMappingsGlobal(UUID operationId,
        ...
        if (mappingsSource.size() > 0 && mappingsTarget.size() > 0) {
            StoreOperationInput innerInputRemoves = new StoreOperationInput.Builder().withShard(mappingsSource.get(0).getLeft().getStoreShard())
                    .build();

            StoreOperationInput innerInputAdds = new StoreOperationInput.Builder().withShard(mappingsTarget.get(0).getLeft().getStoreShard()).build();

            List<StoreOperationInput> steps = new ArrayList<>();
            int id = 0;
            for (Pair<StoreMapping, UUID> pair : mappingsSource) {
                id++;
                steps.add(new StoreOperationInput.Builder().withStepId(id).withValidation(false)
                        .withStoreOperationStepKind(StoreOperationStepKind.Remove).withMapping(pair.getLeft()).withLock(new Lock(pair.getRight(), 0))
                        .build());
            }
            for (Pair<StoreMapping, UUID> pair : mappingsTarget) {
                id++;
                steps.add(
                        new StoreOperationInput.Builder().withStepId(id).withValidation(false).withStoreOperationStepKind(StoreOperationStepKind.Add)
                                .withMapping(pair.getLeft()).withLock(new Lock(pair.getRight(), 0)).build());
            }

            QName rootElementName = new QName("BulkOperationShardMappingsGlobal");
            StoreOperationInput input = new StoreOperationInput.Builder().withOperationId(operationId).withOperationCode(operationCode).withUndo(undo)
                    .withStepsCount(id).withGsmVersion().withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withRemoves(innerInputRemoves)
                    .withAdds(innerInputAdds).withSteps(steps).build();
            return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
        }
     ...
     *            ShardId map whose mappings are being requested.
     * @param mapping
     *            Mapping being locked or unlocked.
     * @param lockId
     *            Lock Id.
     * @param lockOpType
     *            Lock operation code.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> lockOrUnLockShardMappingsGlobal(StoreShardMap shardMap,
            StoreMapping mapping,
            UUID lockId,
        ...
        if (mapping != null || (lockOpType == LockOwnerIdOpType.UnlockAllMappingsForId || lockOpType == LockOwnerIdOpType.UnlockAllMappings)) {
            ...
            StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion()
                    .withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withMapping(mapping).withLock(lock).build();
            return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
        }
    ...
    public static JAXBElement<StoreOperationInput> findShardingSchemaInfoGlobal(String name) {
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withSchemaInfo(new StoreSchemaInfo(name, null)).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *
     * @param schemaInfo
     *            Schema info object to add
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> addShardingSchemaInfoGlobal(StoreSchemaInfo schemaInfo) {
        QName rootElementName = new QName("AddShardingSchemaInfoGlobal");
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion().withSchemaInfo(schemaInfo).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *
     * @param schemaInfo
     *            Schema info object to update
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> updateShardingSchemaInfoGlobal(StoreSchemaInfo schemaInfo) {
     ...
     *
     * @param shardMapName
     *            Optional shard map name to detach.
     * @param location
     *            Location to detach.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> detachShardGlobal(String shardMapName,
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion()
                .withShardMap(shardMapName == null ? StoreShardMap.NULL : new StoreShardMap(null, shardMapName, null, null)).withLocation(location)
                .build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> replaceShardMappingsGlobalWithoutLogging(StoreShardMap shardMap,
            StoreMapping[] mappingsSource,
        ...
        if (mappingsSource.length + mappingsTarget.length > 0) {
            ...
            StoreOperationInput input = new StoreOperationInput.Builder().withGsmVersion()
                    .withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withRemoveStepsCount(mappingsSource.length)
                    .withAddStepsCount(mappingsTarget.length).withRemoveSteps(getStepsFromStoreMappings(mappingsSource))
                    .withAddSteps(getStepsFromStoreMappings(mappingsTarget)).build();
            return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
        }
    ...
    private static StoreOperationInput getStepsFromStoreMappings(StoreMapping[] mappings) {
        ...
        if (mappings.length > 0) {
            ...
            for (StoreMapping mapping : mappings) {
                stepId++;
                steps.add(new StoreOperationInput.Builder().withStepId(stepId).withStoreMapping(mapping).build());
            }
    ...
    public static JAXBElement<StoreOperationInput> getAllShardsLocal() {
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> validateShardLocal(UUID shardMapId,
            UUID shardId,
            UUID shardVersion) {
        QName rootElementName = new QName("ValidateShardLocal");
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withShardMapId(shardMapId).withShardId(shardId)
                .withShardVersion(shardVersion).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *            Operation Id.
     * @param shardMap
     *            ShardId map to add shard to.
     * @param shard
     *            ShardId to add.
     * @param undo
     *            Whether this is undo request.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> addShardLocal(UUID operationId,
            boolean undo,
            StoreShardMap shardMap,
            StoreShard shard) {
        QName rootElementName = new QName("AddShardLocal");
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withOperationId(operationId).withUndo(undo)
     ...
     *            Operation Id.
     * @param shardMap
     *            ShardId map to remove shard from.
     * @param shard
     *            ShardId to remove.
     * @return Xml formatted request.
     */
    ...
    /**
     * Request to get all shard mappings from LSM for a particular shard map and optional shard and range.
     *
     * @param shardMap
     *            ShardId map whose mappings are being requested.
     * @param shard
    ...
    public static JAXBElement<StoreOperationInput> getAllShardMappingsLocal(StoreShardMap shardMap,
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap)
                .withShard(shard == null ? StoreShard.NULL : shard).withShardRange(range).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> validateShardMappingLocal(UUID shardMapId,
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withShardMapId(shardMapId).withMappingId(mappingId).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> addShardMappingLocal(UUID operationId,
        ...
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(
                new StoreOperationInput.Builder().withStepId(1).withStoreOperationStepKind(StoreOperationStepKind.Add).withMapping(mapping).build());

        QName rootElementName = new QName("BulkOperationShardMappingsLocal");
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withOperationId(operationId).withUndo(undo).withStepsCount(1)
                .withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withShard(mapping.getStoreShard()).withSteps(steps).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
     ...
     *            Mapping to remove.
     * @param undo
     *            Whether this is undo operation.
     * @return Xml formatted request.
     */
    public static JAXBElement<StoreOperationInput> removeShardMappingLocal(UUID operationId,
            ...
            StoreMapping mapping) {
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withStoreOperationStepKind(StoreOperationStepKind.Remove).withMapping(mapping)
                .build());
    ...
    public static JAXBElement<StoreOperationInput> updateShardMappingLocal(UUID operationId,
            ...
            StoreMapping mappingTarget) {
        List<StoreOperationInput> steps = new ArrayList<>();
        steps.add(new StoreOperationInput.Builder().withStepId(1).withStoreOperationStepKind(StoreOperationStepKind.Remove).withMapping(mappingSource)
                .build());
        steps.add(new StoreOperationInput.Builder().withStepId(2).withStoreOperationStepKind(StoreOperationStepKind.Add).withMapping(mappingTarget)
                .build());

        QName rootElementName = new QName("BulkOperationShardMappingsLocal");
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withOperationId(operationId).withUndo(undo).withStepsCount(2)
                .withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap).withShard(mappingTarget.getStoreShard()).withSteps(steps).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
    ...
    public static JAXBElement<StoreOperationInput> replaceShardMappingsLocal(UUID operationId,
        ...
        if (mappingsSource.length + mappingsTarget.length > 0) {
            ...
            for (StoreMapping mapping : mappingsSource) {
                id++;
                steps.add(new StoreOperationInput.Builder().withStepId(id).withStoreOperationStepKind(StoreOperationStepKind.Remove)
                        .withMapping(mapping).build());
            }
            for (StoreMapping mapping : mappingsTarget) {
                id++;
                steps.add(new StoreOperationInput.Builder().withStepId(id).withStoreOperationStepKind(StoreOperationStepKind.Add).withMapping(mapping)
                        .build());
            }

            QName rootElementName = new QName("BulkOperationShardMappingsLocal");
            StoreOperationInput input = new StoreOperationInput.Builder().withOperationId(operationId).withUndo(undo).withStepsCount(id)
                    .withLsmVersion().withShardMap(shardMap == null ? StoreShardMap.NULL : shardMap)
                    .withShard(mappingsTarget.length > 0 ? mappingsTarget[0].getStoreShard() : mappingsSource[0].getStoreShard()).withSteps(steps)
                    .build();
            return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
        }
    ...
    public static JAXBElement<StoreOperationInput> killSessionsForShardMappingLocal(String pattern) {
        ...
        StoreOperationInput input = new StoreOperationInput.Builder().withLsmVersion().withPattern(pattern).build();
        return new JAXBElement<>(rootElementName, StoreOperationInput.class, input);
    }
