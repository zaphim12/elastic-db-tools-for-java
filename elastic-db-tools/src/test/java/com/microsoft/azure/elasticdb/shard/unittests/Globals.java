...
final class Globals {
     ...
     */
    static final String CREATE_DATABASE_QUERY = "IF EXISTS" + " (SELECT name FROM sys.databases WHERE name = N'%1$s') BEGIN"
     ...
     */
    static final String SHARD_MAP_MANAGER_TEST_CONN_STRING = Globals.shardMapManagerTestConnectionString();
    /**
    ...
    private static Properties loadProperties() {
        InputStream inStream = Globals.class.getClassLoader().getResourceAsStream("resources.properties");
